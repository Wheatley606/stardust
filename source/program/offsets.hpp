...
namespace exl::reloc {
    ...
    using UserTableSet = TableSet<VersionType, 
		UserTableType<VersionType::DEFAULT,
			...
			{ util::ModuleIndex::Main,          0x0033F864,                 "_ZN11LayoutActorD1Ev" },
		...
		UserTableType<VersionType::V1_2_0,
			...
			{ util::ModuleIndex::Main,          0x00341E34,                 "_ZN11LayoutActorD1Ev" },
		...
		UserTableType<VersionType::V1_3_0,
			...
			{ util::ModuleIndex::Main,          0x00341C14,                 "_ZN11LayoutActorD1Ev" },

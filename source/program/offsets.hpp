...
namespace exl::reloc {
    ...
    using UserTableSet = TableSet<VersionType, 
		UserTableType<VersionType::DEFAULT,
			...
			{ util::ModuleIndex::Main,          0x000D9B50,                 "_ZN2MR17validateHitSensorEP9HitSensor" },
			{ util::ModuleIndex::Main,          0x000D9E20,                 "_ZN2MR19invalidateHitSensorEP9HitSensor" },
			{ util::ModuleIndex::Main,          0x000D9E30,                 "_ZN2MR12isSensorTypeEPK9HitSensorm" },
			...
			{ util::ModuleIndex::Main,          0x00182170,                 "_ZN2MR14createSceneObjEi" },
			...
			{ util::ModuleIndex::Main,          0x001836C0,                 "_ZN14GameScenePatch4initEv" },
			...
			{ util::ModuleIndex::Main,          0x001E8834,                 "_ZN15MarioActorPatch21MarioActorConstructorEv" },
			{ util::ModuleIndex::Main,          0x001ED330,                 "_ZN10MarioActor20takenDamageBehaviourEv" },
			{ util::ModuleIndex::Main,          0x001ED330,                 "_ZN15MarioActorPatch20takenDamageBehaviourEv" },
			{ util::ModuleIndex::Main,          0x001ED42C,                 "_ZN10MarioActor7incLifeEj" },
			{ util::ModuleIndex::Main,          0x001ED42C,                 "_ZN15MarioActorPatch7incLifeEv" },
			{ util::ModuleIndex::Main,          0x001FA7F0,                 "_ZN10MarioActor19LifeRelatedFunctionEv" },
			{ util::ModuleIndex::Main,          0x001FA7F0,                 "_ZN15MarioActorPatch19LifeRelatedFunctionEv" },
			{ util::ModuleIndex::Main,          0x002535C0,                 "_ZN11LayoutActorC1EPKcb" },
			{ util::ModuleIndex::Main,          0x002535C0,                 "_ZN11LayoutActorC2EPKcb" },
			{ util::ModuleIndex::Main,          0x00253604,                 "_ZN11LayoutActor8movementEv" },
			{ util::ModuleIndex::Main,          0x00253680,                 "_ZNK11LayoutActor16getLayoutManagerEv" },
			{ util::ModuleIndex::Main,          0x00253688,                 "_ZN11LayoutActor8calcAnimEv" },
			{ util::ModuleIndex::Main,          0x002536BC,                 "_ZNK11LayoutActor4drawEv" },
			{ util::ModuleIndex::Main,          0x002536F0,                 "_ZN11LayoutActor6appearEv" },
			{ util::ModuleIndex::Main,          0x00253700,                 "_ZN11LayoutActor4killEv" },
			{ util::ModuleIndex::Main,          0x00253730,                 "_ZNK11LayoutActor8setNerveEPK5Nerve" },
			{ util::ModuleIndex::Main,          0x00253738,                 "_ZNK11LayoutActor7isNerveEPK5Nerve" },
			{ util::ModuleIndex::Main,          0x00253764,                 "_ZNK11LayoutActor12getNerveStepEv" },
			{ util::ModuleIndex::Main,          0x00253770,                 "_ZNK11LayoutActor8getTransEv" },
			{ util::ModuleIndex::Main,          0x002537A8,                 "_ZN11LayoutActor8setTransENRK9JGeometry5TVec2IfEE" },
			{ util::ModuleIndex::Main,          0x002537E4,                 "_ZN11LayoutActor16createPaneMtxRefEPKc" },
			{ util::ModuleIndex::Main,          0x002537EC,                 "_ZN11LayoutActor13getPaneMtxRefEPKc" },
			{ util::ModuleIndex::Main,          0x002537F4,                 "_ZN11LayoutActor17initLayoutManagerEPKcj" },
			{ util::ModuleIndex::Main,          0x00253844,                 "_ZN11LayoutActor34initLayoutManagerNoConvertFilenameEPKcj" },
			{ util::ModuleIndex::Main,          0x00253894,                 "_ZN11LayoutActor17initLayoutManagerEPKcjj" },
			{ util::ModuleIndex::Main,          0x002538F0,                 "_ZN11LayoutActor9initNerveEPK5Nerve" },
			{ util::ModuleIndex::Main,          0x00253938,                 "_ZN11LayoutActor16initEffectKeeperEiPKcPK12EffectSystem" },
			{ util::ModuleIndex::Main,          0x002539A0,                 "_ZN11LayoutActor18initPointingTargetEi" },
			{ util::ModuleIndex::Main,          0x00253A44,                 "_ZN11LayoutActorD1Ev" },
			{ util::ModuleIndex::Main,          0x00253A68,                 "_ZN11LayoutActor7controlEv" },
			{ util::ModuleIndex::Main,          0x00253A6C,                 "_ZN15LayoutActorFlagC1Ev" },
			{ util::ModuleIndex::Main,          0x0025A510,                 "_ZN17StarPointerTargetC1EfNPK9JGeometry5TVec3IfEEPA4_fN9JGeometry5TVec3IfEE" },
			{ util::ModuleIndex::Main,          0x0026A7D0,                 "_ZN28CounterLayoutControllerPatch4initEv" },
			{ util::ModuleIndex::Main,          0x0033EAB8,                 "_ZN10ChipHolderC1EPKcl" },
			{ util::ModuleIndex::Main,          0x0033EAB8,                 "_ZN10ChipHolderC2EPKcl" },
			{ util::ModuleIndex::Main,          0x0033EAF4,                 "_ZN10ChipHolder4initERK12JMapInfoIter" },
			{ util::ModuleIndex::Main,          0x0033EBA0,                 "_ZN2MR16createChipHolderEl" },
			{ util::ModuleIndex::Main,          0x0033EBC0,                 "_ZN2MR17registerChipGroupElP9ChipGroup" },
			{ util::ModuleIndex::Main,          0x0033EFC4,                 "_ZN10ChipHolderD1Ev" },
			{ util::ModuleIndex::Main,          0x0033EFE8,                 "_ZN11ChipCounterC1EPKcl" },
			{ util::ModuleIndex::Main,          0x0033EFE8,                 "_ZN11ChipCounterC2EPKcl" },
			{ util::ModuleIndex::Main,          0x0033F034,                 "_ZN11ChipCounter4initERK12JMapInfoIter" },
			{ util::ModuleIndex::Main,          0x0033F1D0,                 "_ZN11ChipCounter7controlEv" },
			{ util::ModuleIndex::Main,          0x0033F864,                 "_ZN11ChipCounterD1Ev" },
			{ util::ModuleIndex::Main,          0x00344044,                 "_ZN9ChipGroup4initERK12JMapInfoIter" },
			{ util::ModuleIndex::Main,          0x00344368,                 "_ZN9ChipGroup8movementEv" },
			{ util::ModuleIndex::Main,          0x003445C4,                 "_ZN9ChipGroupC1EPKcl" },
			{ util::ModuleIndex::Main,          0x003445C4,                 "_ZN9ChipGroupC2EPKcl" },
			{ util::ModuleIndex::Main,          0x00344650,                 "_ZN9ChipGroupD1Ev" },
			{ util::ModuleIndex::Main,          0x003446D8,                 "_ZN8ChipBaseC1EPKclS1_" },
			{ util::ModuleIndex::Main,          0x003446D8,                 "_ZN8ChipBaseC2EPKclS1_" },
			{ util::ModuleIndex::Main,          0x00344738,                 "_ZN8ChipBase4initERK12JMapInfoIter" },
			{ util::ModuleIndex::Main,          0x003448CC,                 "_ZN8ChipBase13initJMapParamERK12JMapInfoIter" },
			{ util::ModuleIndex::Main,          0x00344968,                 "_ZN8ChipBase9initModelERK12JMapInfoIter" },
			{ util::ModuleIndex::Main,          0x00344A18,                 "_ZN8ChipBase10initShadowERK12JMapInfoIter" },
			{ util::ModuleIndex::Main,          0x00344B74,                 "_ZN8ChipBase18initAfterPlacementEv" },
			{ util::ModuleIndex::Main,          0x00344BB0,                 "_ZN8ChipBase8deactiveEv" },
			{ util::ModuleIndex::Main,          0x00344BE4,                 "_ZN8ChipBase10setGroupIDEl" },
			{ util::ModuleIndex::Main,          0x00344BEC,                 "_ZN8ChipBase7setHostEP9LiveActor" },
			{ util::ModuleIndex::Main,          0x00344BF4,                 "_ZN8ChipBase17makeActorAppearedEv" },
			{ util::ModuleIndex::Main,          0x00344C58,                 "_ZN8ChipBase13makeActorDeadEv" },
			{ util::ModuleIndex::Main,          0x00344C8C,                 "_ZN8ChipBase7controlEv" },
			{ util::ModuleIndex::Main,          0x00344CF8,                 "_ZN8ChipBase10appearWaitEv" },
			{ util::ModuleIndex::Main,          0x00344D6C,                 "_ZN8ChipBase14appearFlashingEl" },
			{ util::ModuleIndex::Main,          0x00344DF0,                 "_ZN8ChipBase15receiveOtherMsgEjP9HitSensorS1_" },
			{ util::ModuleIndex::Main,          0x00344F80,                 "_ZN8ChipBase10requestGetEP9HitSensorS1_" },
			{ util::ModuleIndex::Main,          0x00345054,                 "_ZNK8ChipBase10isGettableEv" },
			{ util::ModuleIndex::Main,          0x0034547C,                 "_ZN8ChipBaseD1Ev" },
			...
			{ util::ModuleIndex::Main,          0x0039F08C,                 "_ZN24MorphItemCollectionPatch4initEv" },
			...
			{ util::ModuleIndex::Main,          0x009088D0,                 "_ZN19NameObjFactoryPatch19NameObjListAccessorEv" }
		>,
		...
		UserTableType<VersionType::V1_2_0,
			...
			{ util::ModuleIndex::Main,          0x000D9B80,                 "_ZN2MR17validateHitSensorEP9HitSensor" },
			{ util::ModuleIndex::Main,          0x000D9E50,                 "_ZN2MR19invalidateHitSensorEP9HitSensor" },
			{ util::ModuleIndex::Main,          0x000D9E60,                 "_ZN2MR12isSensorTypeEPK9HitSensorm" },
			...
			{ util::ModuleIndex::Main,          0x001827A0,                 "_ZN2MR14createSceneObjEi" },
			...
			{ util::ModuleIndex::Main,          0x00183D50,                 "_ZN14GameScenePatch4initEv" },
			...
			{ util::ModuleIndex::Main,          0x001E94F4,                 "_ZN15MarioActorPatch21MarioActorConstructorEv" },
			{ util::ModuleIndex::Main,          0x001EDFE0,                 "_ZN10MarioActor20takenDamageBehaviourEv" },
			{ util::ModuleIndex::Main,          0x001EDFE0,                 "_ZN15MarioActorPatch20takenDamageBehaviourEv" },
			{ util::ModuleIndex::Main,          0x001EE0DC,                 "_ZN10MarioActor7incLifeEj" },
			{ util::ModuleIndex::Main,          0x001EE0DC,                 "_ZN15MarioActorPatch7incLifeEv" },
			{ util::ModuleIndex::Main,          0x001FB4C0,                 "_ZN10MarioActor19LifeRelatedFunctionEv" },
			{ util::ModuleIndex::Main,          0x001FB4C0,                 "_ZN15MarioActorPatch19LifeRelatedFunctionEv" },
			{ util::ModuleIndex::Main,          0x00254370,                 "_ZN11LayoutActorC1EPKcb" },
			{ util::ModuleIndex::Main,          0x00254370,                 "_ZN11LayoutActorC2EPKcb" },
			{ util::ModuleIndex::Main,          0x002543B4,                 "_ZN11LayoutActor8movementEv" },
			{ util::ModuleIndex::Main,          0x00254430,                 "_ZNK11LayoutActor16getLayoutManagerEv" },
			{ util::ModuleIndex::Main,          0x00254438,                 "_ZN11LayoutActor8calcAnimEv" },
			{ util::ModuleIndex::Main,          0x0025446C,                 "_ZNK11LayoutActor4drawEv" },
			{ util::ModuleIndex::Main,          0x002544A0,                 "_ZN11LayoutActor6appearEv" },
			{ util::ModuleIndex::Main,          0x002544B0,                 "_ZN11LayoutActor4killEv" },
			{ util::ModuleIndex::Main,          0x002544E0,                 "_ZNK11LayoutActor8setNerveEPK5Nerve" },
			{ util::ModuleIndex::Main,          0x002544E8,                 "_ZNK11LayoutActor7isNerveEPK5Nerve" },
			{ util::ModuleIndex::Main,          0x00254514,                 "_ZNK11LayoutActor12getNerveStepEv" },
			{ util::ModuleIndex::Main,          0x00254520,                 "_ZNK11LayoutActor8getTransEv" },
			{ util::ModuleIndex::Main,          0x00254558,                 "_ZN11LayoutActor8setTransENRK9JGeometry5TVec2IfEE" },
			{ util::ModuleIndex::Main,          0x00254594,                 "_ZN11LayoutActor16createPaneMtxRefEPKc" },
			{ util::ModuleIndex::Main,          0x0025459C,                 "_ZN11LayoutActor13getPaneMtxRefEPKc" },
			{ util::ModuleIndex::Main,          0x002545A4,                 "_ZN11LayoutActor17initLayoutManagerEPKcj" },
			{ util::ModuleIndex::Main,          0x002545F4,                 "_ZN11LayoutActor34initLayoutManagerNoConvertFilenameEPKcj" },
			{ util::ModuleIndex::Main,          0x00254644,                 "_ZN11LayoutActor17initLayoutManagerEPKcjj" },
			{ util::ModuleIndex::Main,          0x002546A0,                 "_ZN11LayoutActor9initNerveEPK5Nerve" },
			{ util::ModuleIndex::Main,          0x002546E8,                 "_ZN11LayoutActor16initEffectKeeperEiPKcPK12EffectSystem" },
			{ util::ModuleIndex::Main,          0x00254750,                 "_ZN11LayoutActor18initPointingTargetEi" },
			{ util::ModuleIndex::Main,          0x002547F4,                 "_ZN11LayoutActorD1Ev" },
			{ util::ModuleIndex::Main,          0x00254818,                 "_ZN11LayoutActor7controlEv" },
			{ util::ModuleIndex::Main,          0x0025481C,                 "_ZN15LayoutActorFlagC1Ev" },
			{ util::ModuleIndex::Main,          0x0025B2C0,                 "_ZN17StarPointerTargetC1EfNPK9JGeometry5TVec3IfEEPA4_fN9JGeometry5TVec3IfEE" },
			{ util::ModuleIndex::Main,          0x0026B6A0,                 "_ZN28CounterLayoutControllerPatch4initEv" },
			{ util::ModuleIndex::Main,          0x00341088,                 "_ZN10ChipHolderC1EPKcl" },
			{ util::ModuleIndex::Main,          0x00341088,                 "_ZN10ChipHolderC2EPKcl" },
			{ util::ModuleIndex::Main,          0x003410C4,                 "_ZN10ChipHolder4initERK12JMapInfoIter" },
			{ util::ModuleIndex::Main,          0x00341170,                 "_ZN2MR16createChipHolderEl" },
			{ util::ModuleIndex::Main,          0x00341190,                 "_ZN2MR17registerChipGroupElP9ChipGroup" },
			{ util::ModuleIndex::Main,          0x00341594,                 "_ZN10ChipHolderD1Ev" },
			{ util::ModuleIndex::Main,          0x003415B8,                 "_ZN11ChipCounterC1EPKcl" },
			{ util::ModuleIndex::Main,          0x003415B8,                 "_ZN11ChipCounterC2EPKcl" },
			{ util::ModuleIndex::Main,          0x00341604,                 "_ZN11ChipCounter4initERK12JMapInfoIter" },
			{ util::ModuleIndex::Main,          0x003417A0,                 "_ZN11ChipCounter7controlEv" },
			{ util::ModuleIndex::Main,          0x00341E34,                 "_ZN11ChipCounterD1Ev" },
			{ util::ModuleIndex::Main,          0x00346614,                 "_ZN9ChipGroup4initERK12JMapInfoIter" },
			{ util::ModuleIndex::Main,          0x00346938,                 "_ZN9ChipGroup8movementEv" },
			{ util::ModuleIndex::Main,          0x00346B94,                 "_ZN9ChipGroupC1EPKcl" },
			{ util::ModuleIndex::Main,          0x00346B94,                 "_ZN9ChipGroupC2EPKcl" },
			{ util::ModuleIndex::Main,          0x00346C20,                 "_ZN9ChipGroupD1Ev" },
			{ util::ModuleIndex::Main,          0x00346CA8,                 "_ZN8ChipBaseC1EPKclS1_" },
			{ util::ModuleIndex::Main,          0x00346CA8,                 "_ZN8ChipBaseC2EPKclS1_" },
			{ util::ModuleIndex::Main,          0x00346D08,                 "_ZN8ChipBase4initERK12JMapInfoIter" },
			{ util::ModuleIndex::Main,          0x00346E9C,                 "_ZN8ChipBase13initJMapParamERK12JMapInfoIter" },
			{ util::ModuleIndex::Main,          0x00346F38,                 "_ZN8ChipBase9initModelERK12JMapInfoIter" },
			{ util::ModuleIndex::Main,          0x00346FE8,                 "_ZN8ChipBase10initShadowERK12JMapInfoIter" },
			{ util::ModuleIndex::Main,          0x00347144,                 "_ZN8ChipBase18initAfterPlacementEv" },
			{ util::ModuleIndex::Main,          0x00347180,                 "_ZN8ChipBase8deactiveEv" },
			{ util::ModuleIndex::Main,          0x003471B4,                 "_ZN8ChipBase10setGroupIDEl" },
			{ util::ModuleIndex::Main,          0x003471BC,                 "_ZN8ChipBase7setHostEP9LiveActor" },
			{ util::ModuleIndex::Main,          0x003471C4,                 "_ZN8ChipBase17makeActorAppearedEv" },
			{ util::ModuleIndex::Main,          0x00347228,                 "_ZN8ChipBase13makeActorDeadEv" },
			{ util::ModuleIndex::Main,          0x0034725C,                 "_ZN8ChipBase7controlEv" },
			{ util::ModuleIndex::Main,          0x003472C8,                 "_ZN8ChipBase10appearWaitEv" },
			{ util::ModuleIndex::Main,          0x0034733C,                 "_ZN8ChipBase14appearFlashingEl" },
			{ util::ModuleIndex::Main,          0x003473C0,                 "_ZN8ChipBase15receiveOtherMsgEjP9HitSensorS1_" },
			{ util::ModuleIndex::Main,          0x00347550,                 "_ZN8ChipBase10requestGetEP9HitSensorS1_" },
			{ util::ModuleIndex::Main,          0x00347640,                 "_ZNK8ChipBase10isGettableEv" },
			{ util::ModuleIndex::Main,          0x00347A68,                 "_ZN8ChipBaseD1Ev" },
			...
			{ util::ModuleIndex::Main,          0x003A16DC,                 "_ZN24MorphItemCollectionPatch4initEv" },
			...
			{ util::ModuleIndex::Main,          0x0090F8D0,                 "_ZN19NameObjFactoryPatch19NameObjListAccessorEv" }
		>,
		...
		UserTableType<VersionType::V1_3_0,
			...
			{ util::ModuleIndex::Main,          0x00182200,                 "_ZN2MR14createSceneObjEi" },
			...
			{ util::ModuleIndex::Main,          0x001837B0,                 "_ZN14GameScenePatch4initEv" },
			...
			{ util::ModuleIndex::Main,          0x001E9044,                 "_ZN15MarioActorPatch21MarioActorConstructorEv" },
			{ util::ModuleIndex::Main,          0x001EDB30,                 "_ZN10MarioActor20takenDamageBehaviourEv" },
			{ util::ModuleIndex::Main,          0x001EDB30,                 "_ZN15MarioActorPatch20takenDamageBehaviourEv" },
			{ util::ModuleIndex::Main,          0x001EDC2C,                 "_ZN10MarioActor7incLifeEj" },
			{ util::ModuleIndex::Main,          0x001EDC2C,                 "_ZN15MarioActorPatch7incLifeEv" },
			{ util::ModuleIndex::Main,          0x001FB040,                 "_ZN10MarioActor19LifeRelatedFunctionEv" },
			{ util::ModuleIndex::Main,          0x001FB040,                 "_ZN15MarioActorPatch19LifeRelatedFunctionEv" },
			{ util::ModuleIndex::Main,          0x00254090,                 "_ZN11LayoutActorC1EPKcb" },
			{ util::ModuleIndex::Main,          0x00254090,                 "_ZN11LayoutActorC2EPKcb" },
			{ util::ModuleIndex::Main,          0x002540D4,                 "_ZN11LayoutActor8movementEv" },
			{ util::ModuleIndex::Main,          0x00254150,                 "_ZNK11LayoutActor16getLayoutManagerEv" },
			{ util::ModuleIndex::Main,          0x00254158,                 "_ZN11LayoutActor8calcAnimEv" },
			{ util::ModuleIndex::Main,          0x0025418C,                 "_ZNK11LayoutActor4drawEv" },
			{ util::ModuleIndex::Main,          0x002541C0,                 "_ZN11LayoutActor6appearEv" },
			{ util::ModuleIndex::Main,          0x002541D0,                 "_ZN11LayoutActor4killEv" },
			{ util::ModuleIndex::Main,          0x00254200,                 "_ZNK11LayoutActor8setNerveEPK5Nerve" },
			{ util::ModuleIndex::Main,          0x00254208,                 "_ZNK11LayoutActor7isNerveEPK5Nerve" },
			{ util::ModuleIndex::Main,          0x00254234,                 "_ZNK11LayoutActor12getNerveStepEv" },
			{ util::ModuleIndex::Main,          0x00254240,                 "_ZNK11LayoutActor8getTransEv" },
			{ util::ModuleIndex::Main,          0x00254278,                 "_ZN11LayoutActor8setTransENRK9JGeometry5TVec2IfEE" },
			{ util::ModuleIndex::Main,          0x002542B4,                 "_ZN11LayoutActor16createPaneMtxRefEPKc" },
			{ util::ModuleIndex::Main,          0x002542BC,                 "_ZN11LayoutActor13getPaneMtxRefEPKc" },
			{ util::ModuleIndex::Main,          0x002542C4,                 "_ZN11LayoutActor17initLayoutManagerEPKcj" },
			{ util::ModuleIndex::Main,          0x00254314,                 "_ZN11LayoutActor34initLayoutManagerNoConvertFilenameEPKcj" },
			{ util::ModuleIndex::Main,          0x00254364,                 "_ZN11LayoutActor17initLayoutManagerEPKcjj" },
			{ util::ModuleIndex::Main,          0x002543C0,                 "_ZN11LayoutActor9initNerveEPK5Nerve" },
			{ util::ModuleIndex::Main,          0x00254408,                 "_ZN11LayoutActor16initEffectKeeperEiPKcPK12EffectSystem" },
			{ util::ModuleIndex::Main,          0x00254470,                 "_ZN11LayoutActor18initPointingTargetEi" },
			{ util::ModuleIndex::Main,          0x00254514,                 "_ZN11LayoutActorD1Ev" },
			{ util::ModuleIndex::Main,          0x00254538,                 "_ZN11LayoutActor7controlEv" },
			{ util::ModuleIndex::Main,          0x0025453C,                 "_ZN15LayoutActorFlagC1Ev" },
			{ util::ModuleIndex::Main,          0x0025AFE0,                 "_ZN17StarPointerTargetC1EfNPK9JGeometry5TVec3IfEEPA4_fN9JGeometry5TVec3IfEE" },
			{ util::ModuleIndex::Main,          0x0026B3C0,                 "_ZN28CounterLayoutControllerPatch4initEv" },
			{ util::ModuleIndex::Main,          0x00340E68,                 "_ZN10ChipHolderC1EPKcl" },
			{ util::ModuleIndex::Main,          0x00340E68,                 "_ZN10ChipHolderC2EPKcl" },
			{ util::ModuleIndex::Main,          0x00340EA4,                 "_ZN10ChipHolder4initERK12JMapInfoIter" },
			{ util::ModuleIndex::Main,          0x00340F50,                 "_ZN2MR16createChipHolderEl" },
			{ util::ModuleIndex::Main,          0x00340F70,                 "_ZN2MR17registerChipGroupElP9ChipGroup" },
			{ util::ModuleIndex::Main,          0x00341374,                 "_ZN10ChipHolderD1Ev" },
			{ util::ModuleIndex::Main,          0x00341398,                 "_ZN11ChipCounterC1EPKcl" },
			{ util::ModuleIndex::Main,          0x00341398,                 "_ZN11ChipCounterC2EPKcl" },
			{ util::ModuleIndex::Main,          0x003413E4,                 "_ZN11ChipCounter4initERK12JMapInfoIter" },
			{ util::ModuleIndex::Main,          0x00341580,                 "_ZN11ChipCounter7controlEv" },
			{ util::ModuleIndex::Main,          0x00341C14,                 "_ZN11ChipCounterD1Ev" },
			{ util::ModuleIndex::Main,          0x003463F4,                 "_ZN9ChipGroup4initERK12JMapInfoIter" },
			{ util::ModuleIndex::Main,          0x00346718,                 "_ZN9ChipGroup8movementEv" },
			{ util::ModuleIndex::Main,          0x00346974,                 "_ZN9ChipGroupC1EPKcl" },
			{ util::ModuleIndex::Main,          0x00346974,                 "_ZN9ChipGroupC2EPKcl" },
			{ util::ModuleIndex::Main,          0x00346A00,                 "_ZN9ChipGroupD1Ev" },
			{ util::ModuleIndex::Main,          0x00346A88,                 "_ZN8ChipBaseC1EPKclS1_" },
			{ util::ModuleIndex::Main,          0x00346A88,                 "_ZN8ChipBaseC2EPKclS1_" },
			{ util::ModuleIndex::Main,          0x00346AE8,                 "_ZN8ChipBase4initERK12JMapInfoIter" },
			{ util::ModuleIndex::Main,          0x00346C7C,                 "_ZN8ChipBase13initJMapParamERK12JMapInfoIter" },
			{ util::ModuleIndex::Main,          0x00346D18,                 "_ZN8ChipBase9initModelERK12JMapInfoIter" },
			{ util::ModuleIndex::Main,          0x00346DC8,                 "_ZN8ChipBase10initShadowERK12JMapInfoIter" },
			{ util::ModuleIndex::Main,          0x00346F24,                 "_ZN8ChipBase18initAfterPlacementEv" },
			{ util::ModuleIndex::Main,          0x00346F60,                 "_ZN8ChipBase8deactiveEv" },
			{ util::ModuleIndex::Main,          0x00346F94,                 "_ZN8ChipBase10setGroupIDEl" },
			{ util::ModuleIndex::Main,          0x00346F9C,                 "_ZN8ChipBase7setHostEP9LiveActor" },
			{ util::ModuleIndex::Main,          0x00346FA4,                 "_ZN8ChipBase17makeActorAppearedEv" },
			{ util::ModuleIndex::Main,          0x00347008,                 "_ZN8ChipBase13makeActorDeadEv" },
			{ util::ModuleIndex::Main,          0x0034703C,                 "_ZN8ChipBase7controlEv" },
			{ util::ModuleIndex::Main,          0x003470A8,                 "_ZN8ChipBase10appearWaitEv" },
			{ util::ModuleIndex::Main,          0x0034711C,                 "_ZN8ChipBase14appearFlashingEl" },
			{ util::ModuleIndex::Main,          0x003471A0,                 "_ZN8ChipBase15receiveOtherMsgEjP9HitSensorS1_" },
			{ util::ModuleIndex::Main,          0x00347330,                 "_ZN8ChipBase10requestGetEP9HitSensorS1_" },
			{ util::ModuleIndex::Main,          0x00347420,                 "_ZNK8ChipBase10isGettableEv" },
			{ util::ModuleIndex::Main,          0x00347848,                 "_ZN8ChipBaseD1Ev" },
			...
			{ util::ModuleIndex::Main,          0x003A14CC,                 "_ZN24MorphItemCollectionPatch4initEv" },
			...
			{ util::ModuleIndex::Main,          0x009108F0,                 "_ZN19NameObjFactoryPatch19NameObjListAccessorEv" }
		>,

		UserTableType<VersionType::V1_4_0,
			{ util::ModuleIndex::Main,          0x00086700,                 "_ZN16GameDataFunction34tryOnDimensionBigCastleGalaxyCometEv" },
			{ util::ModuleIndex::Main,          0x00086C10,                 "_ZN16GameDataFunction13isLuigiPlayerEv" },
			{ util::ModuleIndex::Main,          0x000A0BC0,                 "_ZN13NerveExecutorC1EPKc" },
			{ util::ModuleIndex::Main,          0x000A0BF4,                 "_ZN13NerveExecutorD1Ev" },
			{ util::ModuleIndex::Main,          0x000A0C18,                 "_ZN13NerveExecutor9initNerveEPK5Nervel" },
			{ util::ModuleIndex::Main,          0x000A0C64,                 "_ZN13NerveExecutor11updateNerveEv" },
			{ util::ModuleIndex::Main,          0x000A0C74,                 "_ZN13NerveExecutor8setNerveEPK5Nerve" },
			{ util::ModuleIndex::Main,          0x000A0C7C,                 "_ZNK13NerveExecutor7isNerveEPK5Nerve" },
			{ util::ModuleIndex::Main,          0x000A0CA8,                 "_ZNK13NerveExecutor12getNerveStepEv" },
			{ util::ModuleIndex::Main,          0x000B6320,                 "_ZN2MR13isEqualStringEPKcPKc" },
			{ util::ModuleIndex::Main,          0x000B6340,                 "_ZN2MR17isEqualStringCaseEPKcS1_" },
			{ util::ModuleIndex::Main,          0x000B7950,                 "_ZN2MR17isStageFileSelectEv" },
			{ util::ModuleIndex::Main,          0x000B97D0,                 "_ZN2MR39isGalaxyHorrorCometAppearInCurrentStageEv" },
			{ util::ModuleIndex::Main,          0x000B9B80,                 "_ZN2MR27explainFlyingMarioIfAtFirstEv" },
			{ util::ModuleIndex::Main,          0x000B9BC0,                 "_ZN2MR35isOnGameEventFlagFlyingMarioAtFirstEv" },
			{ util::ModuleIndex::Main,          0x000BA080,                 "_ZN2MR33onGameEventFlagFlyingMarioAtFirstEv" },
			{ util::ModuleIndex::Main,          0x000BA3C0,                 "_ZN2MR29isOnGameEventFlagNormalEndingEv" },
			{ util::ModuleIndex::Main,          0x000BA3D0,                 "_ZN2MR36isOnGameEventFlag120PowerStarsEndingEv" },
			{ util::ModuleIndex::Main,          0x000BA950,                 "_ZN2MR37isGalaxyDarkCometAppearInCurrentStageEv" },
			{ util::ModuleIndex::Main,          0x000BA960,                 "_ZN2MR38isGalaxyQuickCometAppearInCurrentStageEv" },
			{ util::ModuleIndex::Main,          0x000BA970,                 "_ZN2MR39isGalaxyPurpleCometAppearInCurrentStageEv" },
			{ util::ModuleIndex::Main,          0x000BA980,                 "_ZN2MR40isGalaxyRainbowCometAppearInCurrentStageEv" },
			{ util::ModuleIndex::Main,          0x000BB6C0,                 "_ZN2MR20connectToSceneLayoutEP7NameObj" },
			{ util::ModuleIndex::Main,          0x000BEA08,                 "_ZN7NameObj13startMovementEv" },
			{ util::ModuleIndex::Main,          0x000BEA0C,                 "_ZN7NameObj11endMovementEv" },
			{ util::ModuleIndex::Main,          0x000BEA18,                 "_ZN9LiveActor15updateHitSensorEP9HitSensor" },
			{ util::ModuleIndex::Main,          0x000BEA1C,                 "_ZN9LiveActor14receiveMsgPushEP9HitSensorS1_" },
			{ util::ModuleIndex::Main,          0x000BEA24,                 "_ZN9LiveActor21receiveMsgEnemyAttackEjP9HitSensorS1_" },
			{ util::ModuleIndex::Main,          0x000BEBD0,                 "_ZN12JMapLinkInfoC1Ev" },
			{ util::ModuleIndex::Main,          0x000BEBE4,                 "_ZN12JMapLinkInfoC1ERK12JMapInfoIterb" },
			{ util::ModuleIndex::Main,          0x000BEC00,                 "_ZN12JMapLinkInfo13setLinkedInfoERK12JMapInfoIter" },
			{ util::ModuleIndex::Main,          0x000BECEC,                 "_ZN12JMapLinkInfo11setLinkInfoERK12JMapInfoIter" },
			{ util::ModuleIndex::Main,          0x000BEE84,                 "_ZNK12JMapLinkInfo7isValidEv" },
			{ util::ModuleIndex::Main,          0x000BEEAC,                 "_ZN8JMapInfoC1Ev" },
			{ util::ModuleIndex::Main,          0x000BEEBC,                 "_ZN8JMapInfoD1Ev" },
			{ util::ModuleIndex::Main,          0x000BEEC0,                 "_ZN8JMapInfo6attachEPKv" },
			{ util::ModuleIndex::Main,          0x000BEED4,                 "_ZN8JMapInfo7setNameEPKc" },
			{ util::ModuleIndex::Main,          0x000BEEDC,                 "_ZNK8JMapInfo7getNameEv" },
			{ util::ModuleIndex::Main,          0x000BEEF0,                 "_ZNK8JMapInfo14searchItemInfoEPKc" },
			{ util::ModuleIndex::Main,          0x000BEF80,                 "_ZNK8JMapInfo12getValueTypeEPKc" },
			{ util::ModuleIndex::Main,          0x000BF00C,                 "_ZNK8JMapInfo12getValueFastEiiPPKc" },
			{ util::ModuleIndex::Main,          0x000BF05C,                 "_ZNK8JMapInfo12getValueFastEiiPm" },
			{ util::ModuleIndex::Main,          0x000BF0E4,                 "_ZNK8JMapInfo12getValueFastEiiPl" },
			{ util::ModuleIndex::Main,          0x000BF2C0,                 "_ZN2MR11getHashCodeEPKc" },
			{ util::ModuleIndex::Main,          0x000D1C70,                 "_ZN2MR13getObjectNameEPPKcRK12JMapInfoIter" },
			{ util::ModuleIndex::Main,          0x000D1D40,                 "_ZN2MR12isObjectNameERK12JMapInfoIterPKc" },
			{ util::ModuleIndex::Main,          0x000DA040,                 "_ZN2MR17validateHitSensorEP9HitSensor" },
			{ util::ModuleIndex::Main,          0x000DA310,                 "_ZN2MR19invalidateHitSensorEP9HitSensor" },
			{ util::ModuleIndex::Main,          0x000DA320,                 "_ZN2MR12isSensorTypeEPK9HitSensorm" },
			{ util::ModuleIndex::Main,          0x0012DC94,                 "_ZN23ActorStateBaseInterface4initEv" },
			{ util::ModuleIndex::Main,          0x0012DF78,                 "_ZN23ActorStateBaseInterface7controlEv" },
			{ util::ModuleIndex::Main,          0x00139010,                 "_ZN13EventFunction17isStartCometEventEPKc" },
			{ util::ModuleIndex::Main,          0x0015D338,                 "_ZN9LiveActorC1EPKc" },
			{ util::ModuleIndex::Main,          0x0015D3DC,                 "_ZN9LiveActor4initERK12JMapInfoIter" },
			{ util::ModuleIndex::Main,          0x0015D3E0,                 "_ZN9LiveActor6appearEv" },
			{ util::ModuleIndex::Main,          0x0015D3EC,                 "_ZN9LiveActor17makeActorAppearedEv" },
			{ util::ModuleIndex::Main,          0x0015D48C,                 "_ZN9LiveActor4killEv" },
			{ util::ModuleIndex::Main,          0x0015D4E0,                 "_ZN9LiveActor13makeActorDeadEv" },
			{ util::ModuleIndex::Main,          0x0015D558,                 "_ZN9LiveActor8movementEv" },
			{ util::ModuleIndex::Main,          0x0015D6B8,                 "_ZN9LiveActor8calcAnimEv" },
			{ util::ModuleIndex::Main,          0x0015D72C,                 "_ZN9LiveActor10calcAnmMtxEv" },
			{ util::ModuleIndex::Main,          0x0015D77C,                 "_ZN9LiveActor16calcViewAndEntryEv" },
			{ util::ModuleIndex::Main,          0x0015D794,                 "_ZN9LiveActor14receiveMessageEjP9HitSensorS1_" },
			{ util::ModuleIndex::Main,          0x0015D7E8,                 "_ZN9LiveActor17calcAndSetBaseMtxEv" },
			{ util::ModuleIndex::Main,          0x0015D884,                 "_ZNK9LiveActor12getTakingMtxEv" },
			{ util::ModuleIndex::Main,          0x0015D890,                 "_ZN9LiveActor8setNerveEPK5Nerve" },
			{ util::ModuleIndex::Main,          0x0015D898,                 "_ZNK9LiveActor7isNerveEPK5Nerve" },
			{ util::ModuleIndex::Main,          0x0015D8C4,                 "_ZNK9LiveActor12getNerveStepEv" },
			{ util::ModuleIndex::Main,          0x0015D8D0,                 "_ZNK9LiveActor9getSensorEPKc" },
			{ util::ModuleIndex::Main,          0x0015D8E0,                 "_ZNK9LiveActor10getBaseMtxEv" },
			{ util::ModuleIndex::Main,          0x0015D910,                 "_ZN9LiveActor12startClippedEv" },
			{ util::ModuleIndex::Main,          0x0015D970,                 "_ZN9LiveActor10endClippedEv" },
			{ util::ModuleIndex::Main,          0x0015D9D4,                 "_ZN9LiveActor23initModelManagerWithAnmEPKcPKcPKcb" },
			{ util::ModuleIndex::Main,          0x0015DA7C,                 "_ZN9LiveActor9initNerveEPK5Nervel" },
			{ util::ModuleIndex::Main,          0x0015DAC8,                 "_ZN9LiveActor13initHitSensorEl" },
			{ util::ModuleIndex::Main,          0x0015DB08,                 "_ZN9LiveActor10initBinderEffm" },
			{ util::ModuleIndex::Main,          0x0015DBA8,                 "_ZN9LiveActor13initRailRiderERK12JMapInfoIter" },
			{ util::ModuleIndex::Main,          0x0015DBE8,                 "_ZN9LiveActor16initEffectKeeperElPKcb" },
			{ util::ModuleIndex::Main,          0x0015DC90,                 "_ZN9LiveActor9initSoundElPKcNPK9JGeometry5TVec3IfEENRK9JGeometry5TVec3IfEE" },
			{ util::ModuleIndex::Main,          0x0015DCF8,                 "_ZN9LiveActor24initShadowControllerListEm" },
			{ util::ModuleIndex::Main,          0x0015DD3C,                 "_ZN9LiveActor23initActorCollisionPartsEPKcP9HitSensorP14ResourceHolderPA4_fbb" },
			{ util::ModuleIndex::Main,          0x0015DE30,                 "_ZN9LiveActor15initStageSwitchERK12JMapInfoIter" },
			{ util::ModuleIndex::Main,          0x0015DE54,                 "_ZN9LiveActor26initActorStarPointerTargetEfNPK9JGeometry5TVec3IfEEPA4_fN9JGeometry5TVec3IfEE" },
			{ util::ModuleIndex::Main,          0x0015DECC,                 "_ZN9LiveActor18initActorLightCtrlEv" },
			{ util::ModuleIndex::Main,          0x0015DF00,                 "_ZN9LiveActor12attackSensorEP9HitSensorS1_" },
			{ util::ModuleIndex::Main,          0x0015DF04,                 "_ZN9LiveActorD1Ev" },
			{ util::ModuleIndex::Main,          0x0015DF28,                 "_ZN9LiveActor7controlEv" },
			{ util::ModuleIndex::Main,          0x0015DF2C,                 "_ZN9LiveActor22receiveMsgPlayerAttackEmP9HitSensorP9HitSensor" },
			{ util::ModuleIndex::Main,          0x0015DF34,                 "_ZN9LiveActor15receiveOtherMsgEmP9HitSensorP9HitSensor" },
			{ util::ModuleIndex::Main,          0x0015DF3C,                 "_ZN13LiveActorFlagC1Ev" },
			{ util::ModuleIndex::Main,          0x0015F310,                 "_ZN11SensorGroupC1EiPKc" },
			{ util::ModuleIndex::Main,          0x0015F374,                 "_ZN11SensorGroup3addEP9HitSensor" },
			{ util::ModuleIndex::Main,          0x0015F3A0,                 "_ZN11SensorGroup6removeEP9HitSensor" },
			{ util::ModuleIndex::Main,          0x0015F3F8,                 "_ZN16SensorHitCheckerC1EPKc" },
			{ util::ModuleIndex::Main,          0x0015F4F4,                 "_ZN16SensorHitChecker4initERK12JMapInfoIter" },
			{ util::ModuleIndex::Main,          0x0015F508,                 "_ZN16SensorHitChecker9initGroupEP9HitSensor" },
			{ util::ModuleIndex::Main,          0x0015F630,                 "_ZN16SensorHitChecker8movementEv" },
			{ util::ModuleIndex::Main,          0x0015F800,                 "_ZNK16SensorHitChecker13doObjColGroupEP11SensorGroupP11SensorGroup" },
			{ util::ModuleIndex::Main,          0x0015F970,                 "_ZNK16SensorHitChecker19doObjColInSameGroupEP11SensorGroup" },
			{ util::ModuleIndex::Main,          0x0015FAB0,                 "_ZN2MR18initHitSensorGroupEP9HitSensor" },
			{ util::ModuleIndex::Main,          0x0015FADC,                 "_ZN16SensorHitCheckerD1Ev" },
			{ util::ModuleIndex::Main,          0x0015FB00,                 "_ZN15HitSensorKeeperC1Ei" },
			{ util::ModuleIndex::Main,          0x0015FB64,                 "_ZN15HitSensorKeeper3addEPKcmtfP9LiveActorNRK9JGeometry5TVec3IfEE" },
			{ util::ModuleIndex::Main,          0x0015FC28,                 "_ZN15HitSensorKeeper11addCallbackEPKcmtfP9LiveActor" },
			{ util::ModuleIndex::Main,          0x0015FD00,                 "_ZNK15HitSensorKeeper9getSensorEPKc" },
			{ util::ModuleIndex::Main,          0x0015FDC0,                 "_ZN15HitSensorKeeper6updateEv" },
			{ util::ModuleIndex::Main,          0x0015FE10,                 "_ZN15HitSensorKeeper8doObjColEv" },
			{ util::ModuleIndex::Main,          0x0015FE60,                 "_ZN15HitSensorKeeper5clearEv" },
			{ util::ModuleIndex::Main,          0x0015FEA0,                 "_ZN15HitSensorKeeper8validateEv" },
			{ util::ModuleIndex::Main,          0x0015FEF0,                 "_ZN15HitSensorKeeper10invalidateEv" },
			{ util::ModuleIndex::Main,          0x0015FF40,                 "_ZN15HitSensorKeeper16validateBySystemEv" },
			{ util::ModuleIndex::Main,          0x0015FF90,                 "_ZN15HitSensorKeeper18invalidateBySystemEv" },
			{ util::ModuleIndex::Main,          0x0015FFDC,                 "_ZNK15HitSensorKeeper16getNthSensorInfoEi" },
			{ util::ModuleIndex::Main,          0x0015FFF0,                 "_ZNK15HitSensorKeeper13getSensorInfoEPKc" },
			{ util::ModuleIndex::Main,          0x001600B0,                 "_ZN9HitSensorC1EmtfP9LiveActor" },
			{ util::ModuleIndex::Main,          0x00160138,                 "_ZN9HitSensor14receiveMessageEmP9HitSensor" },
			{ util::ModuleIndex::Main,          0x0016014C,                 "_ZN9HitSensor7setTypeEm" },
			{ util::ModuleIndex::Main,          0x001601C4,                 "_ZNK9HitSensor6isTypeEm" },
			{ util::ModuleIndex::Main,          0x001601D4,                 "_ZN9HitSensor8validateEv" },
			{ util::ModuleIndex::Main,          0x00160204,                 "_ZN9HitSensor10invalidateEv" },
			{ util::ModuleIndex::Main,          0x0016024C,                 "_ZN9HitSensor16validateBySystemEv" },
			{ util::ModuleIndex::Main,          0x00160298,                 "_ZN9HitSensor18invalidateBySystemEv" },
			{ util::ModuleIndex::Main,          0x001602E0,                 "_ZN9HitSensor12addHitSensorEP9HitSensor" },
			{ util::ModuleIndex::Main,          0x00160308,                 "_ZN13HitSensorInfo12setFollowPosENPK9JGeometry5TVec3IfEE" },
			{ util::ModuleIndex::Main,          0x00160310,                 "_ZN13HitSensorInfo12setFollowMtxEPA4_f" },
			{ util::ModuleIndex::Main,          0x00160318,                 "_ZN13HitSensorInfoC1EPKcP9HitSensorNPK9JGeometry5TVec3IfEEPA4_fNRK9JGeometry5TVec3IfEEb" },
			{ util::ModuleIndex::Main,          0x00160384,                 "_ZN13HitSensorInfo6updateEv" },
			{ util::ModuleIndex::Main,          0x001604E0,                 "_ZN13HitSensorInfo8doObjColEv" },
			{ util::ModuleIndex::Main,          0x00169B6C,                 "_ZN5SpineC1EPvPK5Nervel" },
			{ util::ModuleIndex::Main,          0x00169BC4,                 "_ZN5Spine6updateEv" },
			{ util::ModuleIndex::Main,          0x00169C60,                 "_ZN5Spine8setNerveEPK5Nerve" },
			{ util::ModuleIndex::Main,          0x00169CAC,                 "_ZNK5Spine15getCurrentNerveEv" },
			{ util::ModuleIndex::Main,          0x00169CC0,                 "_ZN16ActorStateKeeperC1Ei" },
			{ util::ModuleIndex::Main,          0x00169D50,                 "_ZN16ActorStateKeeper8addStateEP23ActorStateBaseInterfacePK5NervePKc" },
			{ util::ModuleIndex::Main,          0x00169D78,                 "_ZN16ActorStateKeeper18updateCurrentStateEv" },
			{ util::ModuleIndex::Main,          0x00169DA0,                 "_ZN16ActorStateKeeper10startStateEPK5Nerve" },
			{ util::ModuleIndex::Main,          0x00169DE4,                 "_ZNK16ActorStateKeeper6isDeadEv" },
			{ util::ModuleIndex::Main,          0x00169E08,                 "_ZN16ActorStateKeeper8endStateEPK5Nerve" },
			{ util::ModuleIndex::Main,          0x00171188,                 "_ZN23ActorStateBaseInterface6updateEv" },
			{ util::ModuleIndex::Main,          0x001711DC,                 "_ZN23ActorStateBaseInterface6appearEv" },
			{ util::ModuleIndex::Main,          0x001711E4,                 "_ZN23ActorStateBaseInterface4killEv" },
			{ util::ModuleIndex::Main,          0x00176AE4,                 "_ZN7NameObjC1EPKc" },
			{ util::ModuleIndex::Main,          0x00176B3C,                 "_ZN7NameObj7setNameEPKc" },
			{ util::ModuleIndex::Main,          0x00176B58,                 "_ZN7NameObjD1Ev" },
			{ util::ModuleIndex::Main,          0x00176B7C,                 "_ZN7NameObj4initERK12JMapInfoIter" },
			{ util::ModuleIndex::Main,          0x00176B80,                 "_ZN7NameObj18initAfterPlacementEv" },
			{ util::ModuleIndex::Main,          0x00176B84,                 "_ZN7NameObj8movementEv" },
			{ util::ModuleIndex::Main,          0x00176B88,                 "_ZNK7NameObj4drawEv" },
			{ util::ModuleIndex::Main,          0x00176B8C,                 "_ZN7NameObj8calcAnimEv" },
			{ util::ModuleIndex::Main,          0x00176B90,                 "_ZN7NameObj16calcViewAndEntryEv" },
			{ util::ModuleIndex::Main,          0x00176B94,                 "_ZN7NameObj15initWithoutIterEv" },
			{ util::ModuleIndex::Main,          0x00176BC8,                 "_ZN7NameObj13setLinkedInfoERK12JMapInfoIter" },
			{ util::ModuleIndex::Main,          0x00176BD0,                 "_ZN7NameObj15executeMovementEv" },
			{ util::ModuleIndex::Main,          0x00176BE8,                 "_ZN7NameObj13syncWithFlagsEv" },
			{ util::ModuleIndex::Main,          0x00176C20,                 "_ZN15NameObjFunction17requestMovementOnEP7NameObj" },
			{ util::ModuleIndex::Main,          0x00176C50,                 "_ZN15NameObjFunction18requestMovementOffEP7NameObj" },
			{ util::ModuleIndex::Main,          0x00178B50,                 "_ZN14NameObjFactory10getCreatorEPKc" },
			{ util::ModuleIndex::Main,          0x0017CC30,                 "_ZN14NameObjFactory13createNameObjI16BenefitItemOneUpEEP7NameObjPKc" },
			{ util::ModuleIndex::Main,          0x0018100C,                 "_ZNK15MorphItemObjNeo6isDemoEv" },
			{ util::ModuleIndex::Main,          0x0018102C,                 "_ZN15MorphItemObjNeo17emitAppearEffectsEv" },
			{ util::ModuleIndex::Main,          0x00181030,                 "_ZN15MorphItemObjNeo20appearTransformationEv" },
			{ util::ModuleIndex::Main,          0x00181034,                 "_ZN15MorphItemObjNeo18killTransformationEv" },
			{ util::ModuleIndex::Main,          0x00181A08,                 "_ZN14SceneObjHolderC1Ev" },
			{ util::ModuleIndex::Main,          0x00181A14,                 "_ZN14SceneObjHolder10newEachObjEi" },
			{ util::ModuleIndex::Main,          0x00182E1C,                 "_ZNK14SceneObjHolder6getObjEi" },
			{ util::ModuleIndex::Main,          0x00182E30,                 "_ZN2MR14createSceneObjEi" },
			{ util::ModuleIndex::Main,          0x00184288,                 "_ZN9GameSceneC1Ev" },
			{ util::ModuleIndex::Main,          0x001843B0,                 "_ZN9GameSceneD1Ev" },
			{ util::ModuleIndex::Main,          0x001843E0,                 "_ZN9GameScene4initEv" },
			{ util::ModuleIndex::Main,          0x001843E0,                 "_ZN14GameScenePatch4initEv" },
			{ util::ModuleIndex::Main,          0x001857A4,                 "_ZN5SceneC1EPKc" },
			{ util::ModuleIndex::Main,          0x0018582C,                 "_ZN5SceneD1Ev" },
			{ util::ModuleIndex::Main,          0x00185850,                 "_ZN5Scene4initEv" },
			{ util::ModuleIndex::Main,          0x00185854,                 "_ZN5Scene5startEv" },
			{ util::ModuleIndex::Main,          0x00185858,                 "_ZN5Scene6updateEv" },
			{ util::ModuleIndex::Main,          0x0018585C,                 "_ZNK5Scene4drawEv" },
			{ util::ModuleIndex::Main,          0x00185860,                 "_ZN5Scene8calcAnimEv" },
			{ util::ModuleIndex::Main,          0x00185864,                 "_ZN5Scene23initNameObjListExecutorEv" },
			{ util::ModuleIndex::Main,          0x001858AC,                 "_ZN5Scene18initSceneObjHolderEv" },
			{ util::ModuleIndex::Main,          0x001E9D64,                 "_ZN10MarioActorC1EPKc" },
			{ util::ModuleIndex::Main,          0x001E9D64,                 "_ZN15MarioActorPatch21MarioActorConstructorEv" },
			{ util::ModuleIndex::Main,          0x001EE878,                 "_ZN10MarioActor20takenDamageBehaviourEv" },
			{ util::ModuleIndex::Main,          0x001EE878,                 "_ZN15MarioActorPatch20takenDamageBehaviourEv" },
			{ util::ModuleIndex::Main,          0x001EE974,                 "_ZN10MarioActor7incLifeEj" },
			{ util::ModuleIndex::Main,          0x001EE974,                 "_ZN15MarioActorPatch7incLifeEv" },
			{ util::ModuleIndex::Main,          0x001FBDC0,                 "_ZN10MarioActor19LifeRelatedFunctionEv" },
			{ util::ModuleIndex::Main,          0x001FBDC0,                 "_ZN15MarioActorPatch19LifeRelatedFunctionEv" },
			{ util::ModuleIndex::Main,          0x00254E40,                 "_ZN11LayoutActorC1EPKcb" },
			{ util::ModuleIndex::Main,          0x00254E40,                 "_ZN11LayoutActorC2EPKcb" },
			{ util::ModuleIndex::Main,          0x00254E84,                 "_ZN11LayoutActor8movementEv" },
			{ util::ModuleIndex::Main,          0x00254F00,                 "_ZNK11LayoutActor16getLayoutManagerEv" },
			{ util::ModuleIndex::Main,          0x00254F08,                 "_ZN11LayoutActor8calcAnimEv" },
			{ util::ModuleIndex::Main,          0x00254F3C,                 "_ZNK11LayoutActor4drawEv" },
			{ util::ModuleIndex::Main,          0x00254F70,                 "_ZN11LayoutActor6appearEv" },
			{ util::ModuleIndex::Main,          0x00254F80,                 "_ZN11LayoutActor4killEv" },
			{ util::ModuleIndex::Main,          0x00254FB0,                 "_ZNK11LayoutActor8setNerveEPK5Nerve" },
			{ util::ModuleIndex::Main,          0x00254FB8,                 "_ZNK11LayoutActor7isNerveEPK5Nerve" },
			{ util::ModuleIndex::Main,          0x00254FE4,                 "_ZNK11LayoutActor12getNerveStepEv" },
			{ util::ModuleIndex::Main,          0x00254FF0,                 "_ZNK11LayoutActor8getTransEv" },
			{ util::ModuleIndex::Main,          0x00255028,                 "_ZN11LayoutActor8setTransENRK9JGeometry5TVec2IfEE" },
			{ util::ModuleIndex::Main,          0x00255064,                 "_ZN11LayoutActor16createPaneMtxRefEPKc" },
			{ util::ModuleIndex::Main,          0x0025506C,                 "_ZN11LayoutActor13getPaneMtxRefEPKc" },
			{ util::ModuleIndex::Main,          0x00255074,                 "_ZN11LayoutActor17initLayoutManagerEPKcj" },
			{ util::ModuleIndex::Main,          0x002550C4,                 "_ZN11LayoutActor34initLayoutManagerNoConvertFilenameEPKcj" },
			{ util::ModuleIndex::Main,          0x00255114,                 "_ZN11LayoutActor17initLayoutManagerEPKcjj" },
			{ util::ModuleIndex::Main,          0x00255170,                 "_ZN11LayoutActor9initNerveEPK5Nerve" },
			{ util::ModuleIndex::Main,          0x002551B8,                 "_ZN11LayoutActor16initEffectKeeperEiPKcPK12EffectSystem" },
			{ util::ModuleIndex::Main,          0x00255220,                 "_ZN11LayoutActor18initPointingTargetEi" },
			{ util::ModuleIndex::Main,          0x002552C4,                 "_ZN11LayoutActorD1Ev" },
			{ util::ModuleIndex::Main,          0x002552E8,                 "_ZN11LayoutActor7controlEv" },
			{ util::ModuleIndex::Main,          0x002552EC,                 "_ZN15LayoutActorFlagC1Ev" },
			{ util::ModuleIndex::Main,          0x0025BD90,                 "_ZN17StarPointerTargetC1EfNPK9JGeometry5TVec3IfEEPA4_fN9JGeometry5TVec3IfEE" },
			{ util::ModuleIndex::Main,          0x0026C1F0,                 "_ZN28CounterLayoutControllerPatch4initEv" },
			{ util::ModuleIndex::Main,          0x00341E28,                 "_ZN10ChipHolderC1EPKcl" },
			{ util::ModuleIndex::Main,          0x00341E28,                 "_ZN10ChipHolderC2EPKcl" },
			{ util::ModuleIndex::Main,          0x00341E64,                 "_ZN10ChipHolder4initERK12JMapInfoIter" },
			{ util::ModuleIndex::Main,          0x00341F10,                 "_ZN2MR16createChipHolderEl" },
			{ util::ModuleIndex::Main,          0x00341F30,                 "_ZN2MR17registerChipGroupElP9ChipGroup" },
			{ util::ModuleIndex::Main,          0x00342334,                 "_ZN10ChipHolderD1Ev" },
			{ util::ModuleIndex::Main,          0x00342358,                 "_ZN11ChipCounterC1EPKcl" },
			{ util::ModuleIndex::Main,          0x00342358,                 "_ZN11ChipCounterC2EPKcl" },
			{ util::ModuleIndex::Main,          0x003423A4,                 "_ZN11ChipCounter4initERK12JMapInfoIter" },
			{ util::ModuleIndex::Main,          0x00342540,                 "_ZN11ChipCounter7controlEv" },
			{ util::ModuleIndex::Main,          0x00342BD4,                 "_ZN11ChipCounterD1Ev" },
			{ util::ModuleIndex::Main,          0x003473B4,                 "_ZN9ChipGroup4initERK12JMapInfoIter" },
			{ util::ModuleIndex::Main,          0x00346938,                 "_ZN9ChipGroup8movementEv" },
			{ util::ModuleIndex::Main,          0x00347934,                 "_ZN9ChipGroupC1EPKcl" },
			{ util::ModuleIndex::Main,          0x00347934,                 "_ZN9ChipGroupC2EPKcl" },
			{ util::ModuleIndex::Main,          0x003479C0,                 "_ZN9ChipGroupD1Ev" },
			{ util::ModuleIndex::Main,          0x00347A48,                 "_ZN8ChipBaseC1EPKclS1_" },
			{ util::ModuleIndex::Main,          0x00347A48,                 "_ZN8ChipBaseC2EPKclS1_" },
			{ util::ModuleIndex::Main,          0x00347AA8,                 "_ZN8ChipBase4initERK12JMapInfoIter" },
			{ util::ModuleIndex::Main,          0x00347C3C,                 "_ZN8ChipBase13initJMapParamERK12JMapInfoIter" },
			{ util::ModuleIndex::Main,          0x00347CD8,                 "_ZN8ChipBase9initModelERK12JMapInfoIter" },
			{ util::ModuleIndex::Main,          0x00347D88,                 "_ZN8ChipBase10initShadowERK12JMapInfoIter" },
			{ util::ModuleIndex::Main,          0x00347EE4,                 "_ZN8ChipBase18initAfterPlacementEv" },
			{ util::ModuleIndex::Main,          0x00347F20,                 "_ZN8ChipBase8deactiveEv" },
			{ util::ModuleIndex::Main,          0x00347F54,                 "_ZN8ChipBase10setGroupIDEl" },
			{ util::ModuleIndex::Main,          0x00347F5C,                 "_ZN8ChipBase7setHostEP9LiveActor" },
			{ util::ModuleIndex::Main,          0x00347F64,                 "_ZN8ChipBase17makeActorAppearedEv" },
			{ util::ModuleIndex::Main,          0x00347FC8,                 "_ZN8ChipBase13makeActorDeadEv" },
			{ util::ModuleIndex::Main,          0x00347FFC,                 "_ZN8ChipBase7controlEv" },
			{ util::ModuleIndex::Main,          0x00348068,                 "_ZN8ChipBase10appearWaitEv" },
			{ util::ModuleIndex::Main,          0x003480DC,                 "_ZN8ChipBase14appearFlashingEl" },
			{ util::ModuleIndex::Main,          0x00348160,                 "_ZN8ChipBase15receiveOtherMsgEjP9HitSensorS1_" },
			{ util::ModuleIndex::Main,          0x003482F0,                 "_ZN8ChipBase10requestGetEP9HitSensorS1_" },
			{ util::ModuleIndex::Main,          0x003483E0,                 "_ZNK8ChipBase10isGettableEv" },
			{ util::ModuleIndex::Main,          0x00348808,                 "_ZN8ChipBaseD1Ev" },
			{ util::ModuleIndex::Main,          0x0035FF10,                 "_ZN15MorphItemObjNeoC1EPKc" },
			{ util::ModuleIndex::Main,          0x0035FF10,                 "_ZN15MorphItemObjNeoC2EPKc" },
			{ util::ModuleIndex::Main,          0x0035FF6C,                 "_ZN15MorphItemObjNeo4initERK12JMapInfoIter" },
			{ util::ModuleIndex::Main,          0x003604E0,                 "_ZN15MorphItemObjNeo18initAfterPlacementEv" },
			{ util::ModuleIndex::Main,          0x003604FC,                 "_ZN15MorphItemObjNeo17makeActorAppearedEv" },
			{ util::ModuleIndex::Main,          0x00360538,                 "_ZN15MorphItemObjNeo13makeActorDeadEv" },
			{ util::ModuleIndex::Main,          0x0036056C,                 "_ZN15MorphItemObjNeo6appearEv" },
			{ util::ModuleIndex::Main,          0x0036064C,                 "_ZN15MorphItemObjNeo4killEv" },
			{ util::ModuleIndex::Main,          0x0036067C,                 "_ZN15MorphItemObjNeo7controlEv" },
			{ util::ModuleIndex::Main,          0x00360A5C,                 "_ZN15MorphItemObjNeo17calcAndSetBaseMtxEv" },
			{ util::ModuleIndex::Main,          0x00360CB4,                 "_ZN15MorphItemObjNeo22receiveMsgPlayerAttackEjP9HitSensorS1_" },
			{ util::ModuleIndex::Main,          0x00360DD4,                 "_ZN15MorphItemObjNeo15receiveOtherMsgEjP9HitSensorS1_" },
			{ util::ModuleIndex::Main,          0x003757E0,                 "_ZN2MR19tryCreateDummyModelEP9LiveActorRK12JMapInfoIterli" },
			{ util::ModuleIndex::Main,          0x003A24F0,                 "_ZN19MorphItemCollectionC1EPKc" },
			{ util::ModuleIndex::Main,          0x003A24F0,                 "_ZN19MorphItemCollectionC2EPKc" },
			{ util::ModuleIndex::Main,          0x003A252C,                 "_ZN19MorphItemCollection4initERK12JMapInfoIter" },
			{ util::ModuleIndex::Main,          0x003A252C,                 "_ZN24MorphItemCollectionPatch4initEv" },
			{ util::ModuleIndex::Main,          0x003A25B4,                 "_ZN19MorphItemCollection16initPowerUpModelERK12JMapInfoIter" },
			{ util::ModuleIndex::Main,          0x003A26F0,                 "_ZN19MorphItemCollection17calcAndSetBaseMtxEv" },
			{ util::ModuleIndex::Main,          0x003A2754,                 "_ZN19MorphItemCollectionD1Ev" },
			{ util::ModuleIndex::Main,          0x003A2778,                 "_ZN19MorphItemCollection7exeWaitEv" },
			{ util::ModuleIndex::Main,          0x00912B40,                 "_ZN19NameObjFactoryPatch19NameObjListAccessorEv" }
		>
    >;
}